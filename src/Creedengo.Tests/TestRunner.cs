...
namespace Creedengo.Tests;

internal delegate Task AnalyzerDlg(string source, LanguageVersion languageVersion = default);
internal delegate Task CodeFixerDlg(string source, string? fixedSource = null, LanguageVersion languageVersion = default);
